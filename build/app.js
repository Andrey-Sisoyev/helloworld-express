...
(function() {
  var assert, assets, asyncTrials, express, files, fs, http, index, misc, path, prettyjson, projHome, rack, user, utils;
  ...
  index = require(projHome + '/build/routes/index').index;
